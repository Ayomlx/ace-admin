...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>分类图管理-扩展管理-<?php echo ($site["SITE_INFO"]["name"]); ?>
        </title>
        <?php $currentNav ='扩展管理 > 分类图 > 列表'; ?>
			...
			<li>
              ...
              <div id="Right">
                <div class="Item hr clearfix">
                  ...
                  <div style="float:right; margin-top:6px;"><a href="<?php echo U('Extend/category_add');?>" class="sbtn on">添加分类图</a></div>
                </div>
